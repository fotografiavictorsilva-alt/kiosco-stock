...
// SVG Icons como componentes locales
export const Icons = {
  Dashboard: () => (
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Aplicar colores del cliente dinámicamente al CSS
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'inventory':
        return <Inventory refreshTrigger={refreshTrigger} triggerRefresh={triggerRefresh} showToast={showToast} />;
      case 'sales':
        return <SalesPOS refreshTrigger={refreshTrigger} triggerRefresh={triggerRefresh} showToast={showToast} />;
      case 'history':
        return <SalesHistory refreshTrigger={refreshTrigger} triggerRefresh={triggerRefresh} showToast={showToast} />;
      case 'settings':
        return (
          <BackupSettings 
      ...
      <aside className="sidebar">
        <div className="sidebar-logo">
          <div className="sidebar-logo-icon">
            {CLIENT_CONFIG.kioskName ? CLIENT_CONFIG.kioskName.charAt(0).toUpperCase() : 'K'}
          </div>
          <span className="sidebar-logo-text">{CLIENT_CONFIG.kioskName || 'Kiosco Stock'}</span>
        </div>
      ...
      {toast.visible && (
        <div className={`toast ${toast.type}`}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            {toast.type === 'danger' && (
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--danger)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            {toast.type === 'warning' && (
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--warning)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
                <line x1="12" y1="9" x2="12" y2="13" />
                <line x1="12" y1="17" x2="12.01" y2="17" />
              </svg>
